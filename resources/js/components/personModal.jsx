...
import ConfirmDialog from './ConfirmDialog';  // Убедись, что этот компонент есть и импорт корректный
...
export default function PersonModal({ person, onClose, onSave }) {
    ...
    const [original] = useState({ ...person }); // копия для сравнения изменений
    ...
    // попытка закрыть — показываем ConfirmDialog, если есть изменения
    const attemptClose = () => {
        if (isDirty) {
            setConfirm(true);
        } else {
    ...
    return (
        <>
            <div
                ...
                onClick={attemptClose} // клик по подложке
            >
                <div
                    style={{
                        width: '66vw',
                ...
                >
                    ...
                    <div style={{ flex: '0 0 33%' }}>
                        ...
                        <div style={{ height: 14 }} /> {/* Отступ в конце */}
                    </div>
